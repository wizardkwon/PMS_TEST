		...
		<div id="footer-menu-form">
			...
			<div id="notice">
				<div id="board-menu">
					...
					<button id="keyword" onclick="search()">검색</button>

					<a id="write-menu" type="button"
						href="${sessionScope.log != null ? 'boardWrite' : '#'}"
						style="${sessionScope.log == null || sessionScope.category.equals('client') ? 'display:none' : ''}">글쓰기</a>
				...
				<table id="notice-table">
					...
					<tbody>
						...
						<tr>
							...
							<td><a
								href="boardDetail?boardNumber=<%=list.get(i).getBoardNumber()%>"><%=list.get(i).getBoardTitle()%></a></td>
				...
				<form id="page-form" method="get" action="your-page-url">
					...
					%>
					<a id="pageBtn" href="board?page=<%=i%>"><%=i%></a>
					<%
					}
					%>
				</form>
